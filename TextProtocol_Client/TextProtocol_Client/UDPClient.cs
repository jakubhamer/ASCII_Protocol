        ...
        /* switch (type)
         {
             case "ID":
                 {
                     index = extensions.IndexOfNth(message, "ID: ", 1);
                     firstChar = message.Substring(index + questionTypeSize, 1);
                     while (firstChar != " ")
                     {
                         info += firstChar;
             ...
             case "OP":
                 {
                     index = extensions.IndexOfNth(message, "OP: ", 1);
                     firstChar = message.Substring(index + questionTypeSize, 1);
                     while (firstChar != " ")
                     {
                         info += firstChar;
             ...
             case "N1":
                 {
                     index = extensions.IndexOfNth(message, "N1: ", 1);
                     firstChar = message.Substring(index + questionTypeSize, 1);
                     while (firstChar != " ")
                     {
                         info += firstChar;
             ...
             case "N2":
                 {
                     index = extensions.IndexOfNth(message, "N2: ", 1);
                     firstChar = message.Substring(index + questionTypeSize, 1);
                     while (firstChar != " ")
                     {
                         info += firstChar;
             ...
             case "SN":
                 {
                     index = extensions.IndexOfNth(message, "SN: ", 1);
                     firstChar = message.Substring(index + questionTypeSize, 1);
                     while (firstChar != " ")
                     {
                         info += firstChar;
             ...
             case "ST":
                 {
                     index = extensions.IndexOfNth(message, "ST: ", 1);
                     firstChar = message.Substring(index + questionTypeSize, 1);
                     while (firstChar != " ")
                     {
                         info += firstChar;
             ...
             case "IC":
                 {
                     index = extensions.IndexOfNth(message, "IC: ", 1);
                     firstChar = message.Substring(index + questionTypeSize, 1);
                     while (firstChar != " ")
                     {
                         info += firstChar;
